...
from unitraj.models.qcnet.utils import merge_edges
...
class QCNetMapEncoder(nn.Module):
    ...
    def forward(self, data: HeteroData) -> Dict[str, torch.Tensor]:
        ...
        edge_index_pt2pl = data['map_point', 'to', 'map_polygon']['edge_index'][0]
        ...
        if 'edge_index' in data['map_polygon', 'to', 'map_polygon']:
